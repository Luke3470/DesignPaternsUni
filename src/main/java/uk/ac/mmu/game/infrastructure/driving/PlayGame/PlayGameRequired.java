...
public class PlayGameRequired implements RequiredDice, RequiredAssetFactory, RequiredWinCondition, RequiredHitCondition {
    ...
    public PlayGameRequired(Dice dice, AssetFactory assetFactory, HitCondition hitCondition, WinCondition winCondition){
        this.dice = dice;
