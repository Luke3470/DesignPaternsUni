...
public class ConsolePlayObserver implements PlayObserver {
  ...
  public void onEvent(OnRoll roll) {
    System.out.println(
        roll.player.getTextColour() + roll.player.getName() + " turn " + roll.turn + " rolls "
            + roll.roll);
  }
  ...
  public void onEvent(OnMove move) {
    System.out.println(
        move.result.player.getTextColour() + move.result.player.getName() + " moves from "
            + move.result.from +
            " to " + move.result.to);
  }
  ...
  public void onEvent(OnWin win) {
    System.out.println(
        win.player.getTextColour() + win.player.getName() + " wins in " + win.turn + " turns!");
