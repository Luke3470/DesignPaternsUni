...
public class Game {
  ...
  public Game(Dice dice, AssetFactory assetFactory, HitCondition hitCondition,
  ...
  public void initialize() {
    Initialization init = new Initialization(this.hitCondition, this.winCondition, this.assets,
        this.dice);
